...
class Carspecifik extends React.Component {
    ...
    render(){
        function setli(){
            ...
            document.getElementById("kmslide").style.display = "none"
            document.getElementById("oilslide").style.display = "block"
        ...
        function setkm(){
            ...
            document.getElementById("kmslide").style.display = "block"
            document.getElementById("oilslide").style.display = "none"
                    ...
                    <div className='carspecifik_left'>
                        ...
                        <div className='oil'>
                            ...
                            <div className='oilcentral'>
                                ...
                                <div className='oilcentral_range'>
                                    ...
                                    <div id="kmslide">
                                        <Slider defaultValue={30} max={this.state.posts3} />
                                    </div>
                                    <p>1</p>
                        ...
                        <div className='carspecifik_left_selects'>
                            <div className='carspecifik_left_selects_item'>
                                ...
                                <p>Пробег (км)</p>
                                <input type="text" id='probeginp' value={this.state.posts4} />
                            </div>
                            <div className='carspecifik_left_selects_item'>
