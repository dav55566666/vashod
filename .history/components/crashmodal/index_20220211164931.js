    ...
    const fileChange = (event) => {
     ...
     function sendcrash(){
        ...
        if(myid!=""){
            ...
            var setidarray = docment.querySelectorAll(".crashedbtn")
            var setid = "crashname"+setidarray.length+1 +""
            let newcrash =" <button id="+setid+" class='crashedbtn crash' value="+document.getElementById("name").value+" data-src="+allcrashimgsrc+" data-name="+document.getElementById("opis").value+" onClick={(e) => setcrash (e)}>{post.carash.crashname}</button>"
