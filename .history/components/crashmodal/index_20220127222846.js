    ...
    function addsliders () {
        if (this.files[0]) {
            ...
            fr.addEventListener("load", function () {
                slide='<div class="swiper-slide"><img src='+ fr.result +'></div>'
                swiperarray.push(slide)
                document.querySelector(".imgswiper .swiper-wrapper").innerHTML = swiperarray
            }, false);
            ...
            <div className='addcrashmodal_cont'>
                ...
                <form>
                    ...
                    <div className='swiper'>
                        <label  id="pct">
                            <input onChange={addsliders} type="file" />
