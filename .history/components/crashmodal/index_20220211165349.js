    ...
    const fileChange = (event) => {
     ...
     function sendcrash(){
        ...
        if(myid!=null){
            ...
            let newcrash =" <button id="+setid+" class='crashedbtn crash' value="+document.getElementById("name").value+" data-src="+allcrashimgsrc+" data-name="+document.getElementById("opis").value+" onClick={(e) => setcrash (e)}>"+document.getElementById("name").value+"</button>"
