...
import serverRuntimeConfig from "../../uikit/api"
...
class Summary extends React.Component {
    ...
    componentDidMount() {
      axios.get(publicRuntimeConfig.api1)
        .then(res => {
          ...
          <div className="summary">
              ...
              <div className='equipment_table'>
                  <div className='table_title'>
                      ...
                      <a>
                        <img src="/icon/peniconwhite.svg" />
                      </a>
                  </div>
                  <div className="table_box">
                  {this.state.posts4.map((post, index) =>
                      <div key={index} className='table_box_item' id={"equip"+index+""}>
                          <div className='name'>
                              <p>{post.equipitem.equipname}</p>
                          </div>
                          <div className='counet'>
                              <span>{post.equipitem.equipkol}</span>
                          </div>
                          <div className='price'>
                              <p>{post.equipitem.equipprice} руб.</p>
                          </div>
