        ...
        <div className="working">
            <form action='' method='POST'>
                ...
                <div className='working_grid'>
                    <button onClick={setwork}>50/50</button>
                    <button onClick={setwork}>70/30</button>
                    <button onClick={setwork}>Аренда посуточная</button>
                    <button onClick={setwork}>Аренда почасовая</button>
                </div>
