...
class Carspecifik extends React.Component {
    ...
    axios.get(api.wheelsapis)
        .then(res => {
            ...
            const posts3 = res.data.carinfo[0].km;
            const posts4 = res.data.carinfo[0].probeg;
            this.setState({posts});
    ...
    render(){
        function setli(){
            ...
            documenmt.querySelector("#pmax").textContent = documenmt.querySelector("#pmax").getAttribute("data-oil")
            documenmt.querySelector(".ant-slider-handle").setAttribute("aria-valuemax", documenmt.querySelector("#pmax").getAttribute("data-oil"))
        }
        function setkm(){
            ...
            console.log(documenmt.getElementById("pmax").getAttribute("data-km"))
            // documenmt.querySelector("#pmax").textContent = documenmt.querySelector("#pmax").getAttribute("data-km")
            // documenmt.querySelector(".ant-slider-handle").setAttribute("aria-valuemax", documenmt.querySelector("#pmax").getAttribute("data-km"))
        }
        function nextpage(){
                        ...
                        <div className='oil'>
                            ...
                            <div className='oilcentral'>
                                ...
                                <div className='oilcentral_range'>
                                    <Slider defaultValue={30} max={this.state.posts2} />
                                    <p>1</p>
                                    <p id='pmax' data-km={this.state.posts3} data-oil={this.state.posts2} >{this.state.posts2}</p>
                                </div>
                            </div>
