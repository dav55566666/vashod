...
class Carspecifik extends React.Component {
    ...
    render(){
        ...
        function nextpage(){
            ...
            document.getElementById("wheels").textContent = document.getElementById("rc_select_3").parentElement.nextElementSibling.getAttribute("title")
            document.getElementById("tread").textContent = document.getElementById("treadinp").value
            document.getElementById("wheels2").textContent = document.getElementById("rc_select_4").parentElement.nextElementSibling.getAttribute("title")
