...
class Carspecifik extends React.Component {
    ...
    render(){
        function setli(){
            ...
            documenmt.querySelector("#pmax").textContent = posts2[0].oil
            documenmt.querySelector(".ant-slider-handle").setAttribute("aria-valuemax", posts2[0].oil)
        }
        function setkm(){
            ...
            documenmt.querySelector("#pmax").textContent = posts2[0].km
            documenmt.querySelector(".ant-slider-handle").setAttribute("aria-valuemax", posts2[0].km)
        }
        function nextpage(){
                        ...
                        <div className='oil'>
                            ...
                            <div className='oilcentral'>
                                ...
                                <div className='oilcentral_range'>
                                    <Slider defaultValue={30} max={this.state.posts2[0].oil} />
                                    <p>1</p>
                                    <p id='pmax'>{this.state.posts2[0].oil}</p>
                                </div>
                            </div>
