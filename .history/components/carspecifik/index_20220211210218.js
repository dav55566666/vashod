...
class Carspecifik extends React.Component {
    ...
    render(){
        ...
        function nextpage(){
            ...
            document.getElementById("bodycleanliness").textContent = document.getElementById("rc_select_1").value
            document.getElementById("interiorcleanliness").textContent = document.getElementById("rc_select_2").value
            document.getElementById("wheels").textContent = document.getElementById("rc_select_3").value
            document.getElementById("tread").textContent = document.getElementById("treadinp").value
            document.getElementById("wheels2").textContent = document.getElementById("rc_select_4").value
                    ...
                    <div className='carspecifik_left'>
                        ...
                        <div className='carspecifik_left_selects'>
                            ...
                            <div className='carspecifik_left_selects_item'>
                                ...
                                <p>Чистота кузова</p>
                                <Select defaultValue="Чистый" id='lastselect'>
