...
class Carspecifik extends React.Component {
    ...
    axios.get(api.wheelsapis)
        .then(res => {
            ...
            const posts2 = res.data.carinfo[0].oil;
            const posts3 = res.data.carinfo[1].km;
            const posts4 = res.data.carinfo[2].probeg;
            this.setState({posts});
    ...
    render(){
        function setli(){
            ...
            document.querySelector("#pmax").textContent = document.querySelector("#pmax").getAttribute("data-oil")
            document.querySelector(".ant-slider-handle").setAttribute("aria-valuemax", document.querySelector("#pmax").getAttribute("data-oil"))
        }
        function setkm(){
            ...
            console.log(document.querySelector("#pmax").getAttribute("data-value"))
            document.querySelector("#pmax").textContent = document.querySelector("#pmax").getAttribute("data-km")
            document.querySelector(".ant-slider-handle").setAttribute("aria-valuemax", document.querySelector("#pmax").getAttribute("data-km"))
        }
        function nextpage(){
                        ...
                        <div className='oil'>
                            ...
                            <div className='oilcentral'>
                                ...
                                <div className='oilcentral_range'>
                                    <Slider defaultValue={30} max={this.state.posts2} id="oilslide" />
                                    <Slider defaultValue={30} max={this.state.posts3} id="kmslide" />
                                    <p>1</p>
                                    <p id='pmax' data-oil={this.state.posts2} data-km={this.state.posts3}>{this.state.posts2}</p>
                                </div>
                            </div>
