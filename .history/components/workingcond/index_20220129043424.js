...
const WorkingCond = () => {
    ...
    function sendwork(){
        ...
        var var2= document.querySelector(".activework").textContent;
        var var3= document.querySelector(".activework").textContent;
        var var4= document.querySelector(".activework").textContent;
        var var5= document.querySelector(".activework").textContent;
        $.ajax({
            type:"POST",
    ...
    return (
        <div className="workingcond">
            ...
            <form action='' method='POST'>
                        ...
                        <div className='time_left'>
                            ...
                            <div className='time_text'>
                                ...
                                <div className='time_text_js'>
                                    <span className='price'>1300</span><span>р</span>
                                    <p>/день </p>
                ...
                <Input classlabel={"ensublabel"} value={"Подтвердить"} className={"submit disbled"} type={"submit"} id={"setwork"} myclick={sendwork} />
            </form>
        </div>
    );
}
