...
class Addcrash extends React.Component {
    ...
    render(){
        ...
        function setcrash(e){
            ...
            console.log(document.querySelectorAll(".imgswiper2 .swiper-slide img").getAttribute("src"))
        ...
        function sendform(){
            var slidersrc = document.querySelectorAll(".imgswiper2 .swiper-slide img").getAttribute("src")
