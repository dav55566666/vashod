                    ...
                    <div className='addcrash_left_box'>
                        <div className='crashdetal'>
                            {this.state.posts.map((post, index) =>
                                <button key={index} value={post.carash.crashname} data-src={post.carash.img.post.crashimg} onClick={(e) => setcrash (e)} className='crashedbtn'>{post.carash.crashname}</button>
                            )}
                        </div>
