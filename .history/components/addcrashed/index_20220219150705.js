    ...
    render(){
        ...
        function setcrash(e){
            ...
            for(var g = 0; g < arraymy2.length; g++){
                if(g>1){
                    allimages.push("<div class='myclickimg'><button class='delateimg'><img src='/icon/deletcrashimg.svg'></button><button class='clouscrashimg'><img src='/icon/clouscrashimg.svg'></button><img class='crashimg' src="+arraymy2[g]+" /></div>")
