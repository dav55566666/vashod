    ...
    render(){
        ...
        function setcrash(e){
            ...
            for(var g = 0; g < arraymy2.length; g++){
                allimages.push("<div data-src="+arraymy2[g]+" class='myclickimg'><button type='button' class='delateimg'><img src='/icon/deletcrashimg.svg'></button><button type='button' class='clouscrashimg'><img src='/icon/clouscrashimg.svg'></button><img class='crashimg' src="+arraymy2[g]+" /></div>")
            }
        ...
        function editcrash(e){
            ...
            for(var i = 0; i < crashimg.length; i++){
                crashimgarray.push(crashimg[i].getAttribute("data-src"))
            }
        ...
        function backto(){
            document.querySelector(".addcrashpage").style.display = "none"
            document.querySelector(".carvievpage").style.display = "block"
        }
        return (
