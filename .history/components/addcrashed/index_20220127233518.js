                    ...
                    <div className='addcrash_left_box'>
                        <div className='crashdetal'>
                            {this.state.posts.map((post, index) =>
                                <button key={index} value={post.carash.crashname} data-src={this.state.post.carash.img.map((post2) =>  post2.crashimg)} onClick={(e) => setcrash (e)} className='crashedbtn'>{post.carash.crashname}</button>
                            )}
                        </div>
