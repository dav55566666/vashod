    ...
    render(){
        ...
        function sendform(){
            ...
            for(var g = 0; g < car.length; g++){
                addcrashed.push("<div className='summary_item_info info_crashed'><div className='info_crashed_title'><p>"+car[g].crashname+"</p><span>"+car[g].crashinfo+"</span></div><div className='info_crashed_img' data-src="+car[g].img+"></div></div>")
                document.getElementById("summarycrash").innerHTML = addcrashed
            }
            console.log(crasharrayimg)
            crasharrayimg.push(document.querySelectorAll(".info_crashed_img"))
            for(var b = 0; b < crasharrayimg.length; b++){
                ...
                for(var i = 0; i < arraymy2.length; i++){
                    ...
                    crasharrayimg[b].innerHTML = imgarray
