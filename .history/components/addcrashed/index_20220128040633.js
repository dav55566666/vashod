...
class Addcrash extends React.Component {
    ...
    render(){
        ...
        function setcrash(e){
            ...
            var crashname = e.target.getAttribute("data-name")
            ...
            // document.getElementById("crashname").textContent(e.target.getAttribute("data-name"))
            // document.getElementById("crashinfo").textContent(e.target.value)
        }
        return (
