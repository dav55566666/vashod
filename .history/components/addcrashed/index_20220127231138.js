                ...
                <div className='addcrash_left'>
                    <div className='addcrash_left_box'>
                        <div className='crashdetal'>
                            <button className='crashedbtn active'>Левое крыло</button>
                            <button className='crashedbtn'>Правое крыло</button>
                            <button className='crashedbtn'>Багажник</button>
                            <button className='crashedbtn'>Левое крыло</button>
                            <button className='crashedbtn'>Багажник</button>
                            <button className='crashedbtn'>Правое крыло</button>
                            <button className='crashedbtn'>Правое крыло</button>
                            <button className='crashedbtn'>Багажник</button>
