                        ...
                        <div className='addcrash_left_box'>
                            <div className='crashdetal'>
                                {this.state.posts.map((post, index) =>
                                    <button key={index} id={post.carash.id.post} className={""+post.carash.class+" crashedbtn"} value={post.carash.crashname} data-src={post.carash.img} data-name={post.carash.crashinfo} onClick={(e) => setcrash (e)}>{post.carash.crashname}</button>
                                )}
                            </div>
