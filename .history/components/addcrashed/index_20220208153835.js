...
class Addcrash extends React.Component {
    ...
    render(){
        ...
        function editcrash(e){
            ...
            var crashinfo = e.target.parentElement.parentElement.parentElement.nextSibling.children[0].textContent;
            var crashimg = e.target.parentElement.parentElement.parentElement.nextSibling.nextSibling.children
            document.getElementById("name").value = crashname;
            document.getElementById("opis").value = crashinfo;
            document.querySelector(".imgswiper .swiper-wrapper").innerHTML = crashimg;
            document.querySelector(".addcrashmodal").style.display = "block"
        }
        return (
